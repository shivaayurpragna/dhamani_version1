...
if customer_type == "New Customer":
    ...
    #st.text(f"Date of Birth: {dob.isoformat()}")
    ...
    if st.button("Submit"):
        try : 
            ...
            max_user_id = max(user_ids, default=0)  # Use default=0 for empty list
            user_id = max_user_id + 1

            post_url = "http://98.70.52.225:8000/insert"
            json_data = {"collection" : "user_data", 
...
# --- Now it will star further processing ----# 
